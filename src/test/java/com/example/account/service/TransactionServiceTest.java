...
class TransactionServiceTest {
    ...
    void successUseBalance() {
        ...
        //when
        TransactionDto transactionDto = transactionService.useBalance(1L, "1000000000", 200L); // 이 값은 의미X
    ...
    void exceedAmount_useBalance() {
        ...
        verify(transactionRepository, times(0)).save(any()); //transaction테이블에 record가 저장되지 않는다
    ...
    void successCancelBalance() {
        ...
        Account account = Account.builder()
                ...
                .balance(10000L)
                .accountNumber("1000000012").build();
        Transaction transaction = Transaction.builder() // 원래 거래
                .account(account)
                .transactionType(USE)
                .transactionResultType(S)
